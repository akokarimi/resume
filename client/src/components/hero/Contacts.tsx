...
function Contacts() {
  return (
    <div className="fixed z-10 tranform -translate-y-1/2  top-1/2 right-0 flex flex-col items-center p-1 gap-4 bg-light1 dark:bg-dark1 shadow-lg rounded-lg">
      <a
        href="https://www.instagram.com/akoo0o"
        target="_blank"
        rel="noreferrer noopener"
      >
        <svg className="w-4 h-4 md:w-5 md:h-5 lg:w-6 lg:h-6 hover:scale-125 transition duration-100 fill-dark1 dark:fill-light1">
